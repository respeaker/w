...
var Quiet = (function() {
    ...
    function start() {
        ...
        request.open('GET', 'js/hello.wav', true);
        ...
        audioCtx.decodeAudioData(audioData, function(buffer) {
            brandSound = buffer.getChannelData(0);
            console.log(brandSound.length);
        },
    ...
    function transmitter(opts) {
        ...
        var onaudioprocess = function(e) {
            ...
            for (var i = 0; i < output_r.length; i++) {
                if (brandSoundIndex < brandSound.length) {
                    output_r[i] = brandSound[brandSoundIndex];
                    // output_r[i] = Math.sin(brandSoundIndex / 100.);
                    brandSoundIndex += 1;
                } else {
                    output_r[i] = 0.;
                }
